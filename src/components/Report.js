    ...
    <View >
        <Card style={{alignItems: 'center'}}>
            ...
            <Text styles={styles.baseText}>   
                    {billVote.vote == "Approve" && <Text><Ionicons name="md-checkmark-circle" size={15} color="green" /> You voted to Approve this bill</Text>}
                    {billVote.vote != "Approve" && <Text><Ionicons name="alert-circle" size={15} color="red" /> You voted to Reject this bill</Text>}
            </Text>
            <Text></Text>
            <Card.Row>
                    <Text>
